...
//                save(libraryEvent);
    ...
    private void validate(LibraryEvent libraryEvent) {
        ...
        var libraryEventOptional = libraryEventsRepository.findById(libraryEvent.getLibraryEventId());
...
//        var libraryEventEntity = libraryEventsRepository.findById(libraryEvent.getLibraryEventId()).orElseThrow();
//        libraryEventEntity.setBook(libraryEvent.getBook());
